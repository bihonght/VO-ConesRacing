...
class State(): 
    def __init__(self):
        ...
        self.inliers_matches_for_3d_ = []  # Good triangulation results
        self.inliers_pts3d_ = []  # 3D points from triangulation
        self.inliers_to_mappt_connections_ = {}  # Unordered map for point connections
        ...
        self.camera_ = None
        # -- Current pose
        self.T_w_c_ = None  # Transform from world to camera
